...
class LostAssetsReportComponent extends Component {
    ...
    handleSubmit = () => {
        ...
        Axios.post(apiUrl() + 'lost-assets/report', data)
            .then(resData => {
                if (resData.status) {
                    this.setState({
            ...
            <>
                ...
                <div className={'rounded m-2 bg-white max-h-80vh ui-report-container px-3'}>
                    <nav className="navbar text-center mb-2 mt-1 pl-2 rounded">
                        <p className="text-blue f-weight-700 f-20px m-0">Lost Assets Report</p>
                    </nav>
...
export default LostAssetsReportComponent;