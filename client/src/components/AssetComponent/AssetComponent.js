        ...
        return(
            ...
            <div className={'bg-glass w-90 mx-auto p-3 mt-4 rounded'}>
                <nav className="navbar bg-pink text-center mb-3 p-2 rounded">
                    <p className="text-white m-0" href="#">Add Product</p>
                </nav>
                <form>
            ...
            {submitProduct && <div className={'bg-glass w-90 mx-auto p-3 mt-4 rounded'}>
                <nav className="navbar bg-pink text-center mb-3 p-2 rounded">
                    <p className="text-white m-0">Submit Product</p>
                </nav>
